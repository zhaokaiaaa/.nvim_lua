...
vim.o.mkdp_auto_start = 0
vim.o.mkdp_auto_close = 1
vim.o.mkdp_refresh_slow = 0
vim.o.mkdp_command_for_global = 0
vim.o.mkdp_open_to_the_world = 0
vim.o.mkdp_echo_preview_url = 0
vim.o.mkdp_browserfunc = ''
vim.o.mkdp_page_title = '「${name}」'
